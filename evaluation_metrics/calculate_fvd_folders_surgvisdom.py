...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder2", type=str, default="/data_hdd/xyliu/medical_videos/surgvisdom/train/Porcine/frames_short_clip_128", help="The folder path of the second set of videos.")
