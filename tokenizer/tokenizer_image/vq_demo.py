...
if __name__ == "__main__":
    ...
    parser.add_argument("--vq-ckpt", type=str, default="/data_hdd/xyliu/llamagen_experiments/ft_vq_ds16_c2i/2024-12-03-19-36-38/004-VQ-16/checkpoints/0000300.pt", help="ckpt path for vq model")
