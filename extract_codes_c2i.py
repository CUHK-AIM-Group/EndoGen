...
def main(args):
    ...
    if args.aug == 'ten_crop':
        ...
        raise NotImplementedError(f"Augmentation {args.aug} not implemented.")
    dataset = build_dataset(args, transform=transform)
    print(dataset.classes)

    class_names = dataset.classes
    # Map IDs to class names
    id_to_class = {idx: class_name for idx, class_name in enumerate(class_names)}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--aug", type=str, choices=['default', 'ten_crop', 'none'], default='none')
