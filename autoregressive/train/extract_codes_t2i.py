...
class CustomDataset(Dataset):
    def __init__(self, lst_dir, start, transform):
        img_path_list = []
        # for lst_name in sorted(os.listdir(lst_dir))[start:]:
...
def main(args):
    ...
    dataset = CustomDataset(args.data_path, args.data_start, transform=transform)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="/data_hdd/xyliu/natural_videos/fewshot_t2v/training_data_per_motion/horse_run.jsonl")
    parser.add_argument("--code-path", type=str, default="/data_hdd/xyliu/natural_videos/fewshot_t2v/training_data_per_motion/horse_run_code")
    parser.add_argument("--data-start", type=int, default=0)
    parser.add_argument("--vq-model", type=str, choices=list(VQ_models.keys()), default="VQ-16")
    parser.add_argument("--vq-ckpt", type=str, default="/data_hdd/xyliu/llamagen_experiments/pretrained_models/vq_ds16_t2i.pt")
